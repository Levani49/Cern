...
export default function MenuDropdown({
  ...
  return (
    <div
      className={`mt-8 hidden group-hover:flex group-active:flex flex-col w-auto h-auto absolute bg-transparentDark border dark:bg-dark border-gray-600 rounded ${
        className ? className : ""
      }`}
    >
      {children}
