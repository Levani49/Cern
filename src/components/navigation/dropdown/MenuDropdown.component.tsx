...
export default function MenuDropdown({ children, className }: Props): JSX.Element {
  const defaultClasses = twMerge(
    "absolute left-1/2 mt-[30px] hidden h-auto  w-auto -translate-x-1/2 transform flex-row rounded border border-gray-600 bg-dark group-hover:flex group-active:flex dark:bg-customGray  z-50",
    className
  );
