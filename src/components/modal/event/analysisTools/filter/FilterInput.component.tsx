...
export default function FilterInput({
  ...
  return (
    <div className="relative flex w-full flex-wrap items-center">
      ...
      <input
        className="ml-[-3px] mt-[1px] w-16 flex-grow rounded-t-sm border border-transparentGray bg-transparentLight px-[0.25rem] py-[0.1rem] text-sm text-light outline-none md:flex-grow-0"
