    ...
    <Draggable nodeRef={nodeRef} bounds="parent" handle=".handle">
      <div ref={nodeRef} className="modal text-white z-50 rounded min-w-[200px]">
        <div className="w-full">
          ...
          <div className="handle shadow-md p-1 flex justify-between items-center cursor-move sticky top-0 bg-transparentDark dark:bg-customGray z-[2000]">
          ...
          <div className="p-2 bg-transparentBackground dark:bg-customGray">{children}</div>
        </div>
      </div>
    </Draggable>,
