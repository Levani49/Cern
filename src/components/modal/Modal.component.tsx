    ...
    <Draggable nodeRef={nodeRef} bounds="parent" handle=".handle">
      ...
      >
        <div className={c}>
          ...
          <div className="handle sticky  top-0 z-[2000] flex cursor-grab items-center justify-between bg-dark1 p-[0.15rem] shadow-md transition-colors hover:text-white dark:bg-gray1">
          ...
          <div className="rounded-t-2xl bg-dark3 p-2 dark:bg-dark1">{children}</div>
        </div>
      </div>
    </Draggable>,
