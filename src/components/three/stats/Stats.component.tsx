...
export default function Stats(): JSX.Element {
  ...
  return (
    <>
      {show && (
        <div className="absolute bottom-[48px] left-1/2 z-[9999] flex -translate-x-1/2 -translate-y-1/2 transform select-none gap-3 text-xs font-normal text-white sm:bottom-[1px]">
