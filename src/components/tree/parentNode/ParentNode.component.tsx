...
export default function ParentNode({
  ...
  const styles = `border-l-[1px] border-transparent text-left transition before:relative before:inline-block before:w-[15px] before:left-[-1px] before:align-middle before:border before:border-t-[0.5px] before:border-0 before:text-white before:align-middle ${
