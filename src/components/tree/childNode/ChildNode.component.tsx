  ...
  return (
    ...
    >
      <span
        ...
        className="relative left-0 ml-[-0.5px] cursor-pointer overflow-ellipsis whitespace-nowrap border-white text-left align-middle text-[0.75rem] text-xs font-medium uppercase  transition before:relative before:mr-[2px] before:inline-block before:w-[15.5px] before:border-0  before:border-t-[0.5px] before:align-middle before:text-white sm:font-light"
      >
        {name}
      </span>
    </li>
